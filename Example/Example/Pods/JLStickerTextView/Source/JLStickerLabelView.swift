...
public class JLStickerLabelView: UIView {
    ...
    public var lastTouchedView: JLStickerLabelView?
    
    var delegate: JLStickerLabelViewDelegate?
    
    public var globalInset: CGFloat?
    
    public var initialBounds: CGRect?
    public var initialDistance: CGFloat?
    
    public var beginningPoint: CGPoint?
    public var beginningCenter: CGPoint?
    
    public var touchLocation: CGPoint?
    
    public var deltaAngle: CGFloat?
    public var beginBounds: CGRect?
    ...
    public var isShowingEditingHandles = true
